                ...
                <div className="hero__form relative">
                  ...
                  >
                    <div className="rounded-lg overflow-hidden pt-2 pb-8 px-2 bg-white border shadow-2xl">
                      ...
                      <button className="focus:outline-none bg-gradient-to-br from-blue-400 to-blue-800 hover:from-blue-800 hover:to-blue-400 rounded-xl absolute text-white font-bold px-7 py-4 left-1/2 transform -translate-x-1/2">
                        RECHERCHER
                      </button>
                    </div>
                  </form>
                      ...
                      <div className="overflow-x-auto flex col-span-3">
                        {train.length === 0 && (
                            <div className="p-9 inline-block m-auto">
                              <p className="text-gray-500 font-sans font-bold">Pas de resultats trouvé pour votre recherche 😕</p>
                              <div className="flex w-64 ml-12 p-5">
                                <img src="nosearch.svg" alt="image pas de recherche"/>
                              </div>
                            </div>
                        )}
                        {train}
