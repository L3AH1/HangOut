    ...
    return (
      <div className={styles.container}>
        ...
        <main className="flex flex-col bg-gray-50">
            ...
            <div className="container max-w-4xl mx-auto px-4 h-full flex flex-col items-center">
              <div className="hero__heading text-center">
                <h2 className="text-5xl text-white font-extrabold max-w-prose mb-2">
                  Découvrez nos propositions de voyages
                </h2>
              </div>
              <div className="rounded-lg pb-5 px-2 bg-white border shadow-2xl m-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8">
                    ...
                    <div className="border border-gray-200 rounded-lg w-50 h-12 mb-3 mt-5 ml-3 p-5 flex items-center gap-2 ">
                      ...
                      <div className="flex-1">
                        <label className="block text-blue-400 font-bold text-sm uppercase tracking-wide">
                          Départ{" "}
                          <p className="inline text-gray-500 text-xs normal-case font-normal">
                            (Précédent : {this.state.ville})
                          </p>
                        </label>
                        <Autocomplete
                          suggestions={villes}
                    ...
                    <div className="border border-gray-200 rounded-lg w-50 h-12 mt-3 ml-3 mb-5 p-5 flex items-center gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          name="date_depart"
                          type="date"
                          defaultValue={this.state.date_depart}
          ...
          <section className=" flex-3 flex flex-col py-10 bg-blue-50">
            <p className="text-4xl font-bold mb-7 ml-7 outline">
              Au départ de {this.state.ville} :
            </p>
            <div className="grid grid-flow-row grid-cols-1 md:grid-cols-4 md:gap-8 justify-center">
              <div className="flex justify-center align-center">
                <div className="absolute left-0 mb-10 ml-5 bg-yellow-400 rounded">
                  <p className="text-white font-bold m-2 text-center">
                    Selectionnez votre <br />
                    voyage en train
                  </p>
                </div>
                <div className="m-auto h-1/2 w-1/2 flex justify-center">
                  <svg
                    className="h-auto w-auto max-h-64 max-w-64 p-3"
                    id="fi_2077150"
                ...
                {train.length == 0 && (
                  <div className="p-9 justify-center">
                    <p className="text-gray-500 font-sans font-bold">
                      Pas de resultats trouvé pour votre recherche 😕
                    </p>
                    <div className="flex w-64 ml-12 p-5">
                      <img src="nosearch.svg" />
                    </div>
                  </div>
                )}
                {train}
