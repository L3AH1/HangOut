              ...
              <div className="rounded-lg pb-8 px-2 bg-white border shadow-2xl">
                <div className="px-4 py-8 mb-4">
                  <div className="flex gap-8 flex-row-reverse flex items-center pr-56">
                    <div>
                      <h6 className="text-2xl font-bold">Bienvenue {username},</h6>
                    </div>
                    <div>
                      ...
                      <p>
                        ...
                        {data && data.length == 0 && (
                          <div className="text-center">
                            <img
                              src="empty.svg"
                              className="h-auto max-h-60 text-center mx-auto my-3"
                            />
                            <p className=" text-gray-400 font-semibold text-lg my-4">
                              Vous n'avez pas de voyages sauvegardés{" "}
                            </p>
                          </div>
                        )}
                        {data.map((travels) => {
