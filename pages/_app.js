...
function MyApp({ Component, pageProps }) {
  ...
  return (
  <div>
    {connected ? <Navbar_connect onDeconnect={handleDeconnect}/> : <Navbar/>}
    {/* { loginEmail === null ? <Navbar /> : <Navbar_connect onDeconnect={onDeconnect} />} */}
    <Component  loginEmail={loginEmail} setLoginEmail={setLoginEmail} {...pageProps} />
  </div>
  )
}
