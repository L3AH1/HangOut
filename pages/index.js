...
import Hformulaire, {
  CheckboxesTags,
  HinputAutocompletion,
  HTimePickers
} from "../components/Hformulaire";
...
export default class Home extends React.Component{
  ...
  handleSubmit(){
    if(document.getElementById("ville").value){
      variableFormulaire.ville = document.getElementById("ville").value;
    }
    if(document.getElementById("dateDepart").value){
      variableFormulaire.dateDepart = document.getElementById("dateDepart").value;
    }
    if(document.getElementById("dateRetour").value){
      variableFormulaire.dateRetour = document.getElementById("dateRetour").value;
    }
    if(document.getElementById("duree").value){
      variableFormulaire.duree = document.getElementById("duree").value;
    }
  }
                  ...
                  <div className="rounded-lg overflow-hidden pb-8 px-2 bg-white border shadow-2xl">
                    <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8">
                      ...
                      <div className="p-2 flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <HinputAutocompletion id="ville" label="Ville" placeholder="ex. Monaco"
                      ...
                      <div className="p-2 flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <CheckboxesTags id={"environnement"}
                                          label={"Environnement"}
                                          placeholder={"ex. plage"}
                                          value={this.state.environnement}
                                          onChange={(event, newValue) => {
                                            this.setState({
                                              environnement:newValue
                                            })
                                           // variableFormulaire["environnement"] = [...newValue];
                                          }}/>
                        </div>
                      </div>
                      {/* ENVIES */}
                      <div className="p-2 flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <CheckboxesTags id="envie" label={"Envie"}
                                          value={this.state.envie}
                                          onChange={(event, newValue) => {
                                            this.setState({
                                              envie:newValue
                                            })
                                            variableFormulaire["envie"] = [...newValue];
                                          }}/>
                        </div>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8">
                      ...
                      <div className="p-2 flex items-center gap-2">
                        ...
                        <Hformulaire id="dateDepart" label={"Départ"} value={this.state.dateDepart} onChange={(date)=>this.setState({
                          dateDepart:date
                        })}/>
                      ...
                      <div className="p-2 flex items-center gap-2">
                        ...
                        <Hformulaire id={"dateRetour"} label={"Retour"} value={this.state.dateRetour} onChange={(date)=>this.setState({
                          dateRetour:date
                        })}/>
                      </div>
                      {/* DUREE */}
                      <div className="p-2 flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <HTimePickers id={"duree"} value={this.state.duree} onChange={(heure)=>this.setState({
                            duree:heure
                          })}/>
                        </div>
                      </div>
                    ...
                    <button
                        className="flex items-center gap-2 text-lg font-bold bg-yellow-500 text-white py-3 px-6 rounded-full absolute -bottom- left-1/2 transform -translate-x-1/2"
