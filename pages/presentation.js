        ...
        <div>
          ...
          <main>
                        ...
                        <div>
                          ...
                          >
                            <g>
                              <g>
                                <path
                                    d="M422,96c-5.52,0-10,4.48-10,10s4.48,10,10,10c5.52,0,10-4.48,10-10S427.52,96,422,96z"/>
                              </g>
                            </g>
                            <g>
                              <g>
                                <path
                                    d="M422,296c-5.52,0-10,4.48-10,10c0,5.52,4.48,10,10,10c5.52,0,10-4.48,10-10C432,300.48,427.52,296,422,296z"/>
                              </g>
                            </g>
                            <g>
                              <g>
			...
			c2.668,0,5.179,1.041,7.068,2.931c1.891,1.89,2.932,4.4,2.932,7.069v402h-20V30z M73.621,246l-48-40l48-40H226v80H73.621z
			 ...
			 M438.38,346H286v-80h152.38l48,40L438.38,346z"
                            ...
                            <g>
                              <g>
                                <path
                                    d="M382,96h-66c-5.522,0-10,4.477-10,10s4.478,10,10,10h66c5.522,0,10-4.477,10-10S387.522,96,382,96z"/>
                              </g>
                            </g>
                            <g>
                              <g>
                                <path
                                    d="M382,296h-66c-5.522,0-10,4.477-10,10s4.478,10,10,10h66c5.522,0,10-4.477,10-10S387.522,296,382,296z"/>
                              </g>
                            </g>
                            <g>
                              <g>
                                <path
                                    d="M196,196h-86c-5.523,0-10,4.477-10,10s4.477,10,10,10h86c5.523,0,10-4.477,10-10S201.523,196,196,196z"/>
                              </g>
                            </g>
                          </svg>
                        </div>
                      ...
                      <div className="flex gap-8 flex-row-reverse">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <path
                                d="m7.5 14h-4c-1.93 0-3.5-1.57-3.5-3.5 0-.934.364-1.812 1.026-2.474s1.541-1.026 2.474-1.026h15c1.93 0 3.5 1.57 3.5 3.5 0 .276-.224.5-.5.5s-.5-.224-.5-.5c0-1.379-1.122-2.5-2.5-2.5h-15c-.666 0-1.293.261-1.767.733s-.733 1.101-.733 1.767c0 1.379 1.122 2.5 2.5 2.5h4c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                            <path
                            ...
                            <path
                                d="m9.5 20h-6c-1.93 0-3.5-1.57-3.5-3.5 0-.934.364-1.812 1.026-2.474s1.541-1.026 2.474-1.026h4c.276 0 .5.224.5.5s-.224.5-.5.5h-4c-.666 0-1.293.261-1.767.733s-.733 1.101-.733 1.767c0 1.379 1.122 2.5 2.5 2.5h6c.276 0 .5.224.5.5s-.224.5-.5.5z"/>
                            <path
                  ...
                  <div className="border p-4 text-center rounded-lg shadow bg-white">
                    ...
                    >
                      <g id="saving-marketing-seo-money-piggy">
                        ...
                        <path
                            d="m39 24h2v-2a2 2 0 0 0 2-2v-2a2 2 0 0 0 -2-2h-2v-2h4v-2h-2v-2h-2v2a2 2 0 0 0 -2 2v2a2 2 0 0 0 2 2h2v2h-4v2h2z"/>
                        <path
            ...
            <section className={styles.heroteam + " py-12 min-h-96"}>
              ...
              <div
                  className="grid px-4 gap-4 justify-center bg-black bg-opacity-50 container mx-auto max-w-4xl text-white rounded-xl">
