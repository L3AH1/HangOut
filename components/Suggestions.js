 ...
 *  Class Suggestion,
 *
 *  Display a proposal of journeys chosen by the developers
 *
 */

import React, { useState } from "react";

//Date of the day, for the Navitia's request
const date = new Date();
...
//Distribution of the city by Departure City and Arrival City
...
const JOURNEYS = [
  {
    departure: "Le Havre",
    answer: <DESTINATION id={0} />,
  },
  {
    departure: "Bordeaux",
    answer: <DESTINATION id={9} />,
  },
  {
    departure: "Brest",
    answer: <DESTINATION id={18} />,
  },
  {
    departure: "Bayonne",
    answer: <DESTINATION id={27} />,
  },
  {
    departure: "Arles",
    answer: <DESTINATION id={36} />,
  },
  {
    departure: "Annecy",
    answer: <DESTINATION id={45} />,
  },
  {
    departure: "Montgenevre",
    answer: <DESTINATION id={54} />,
  },
  {
    departure: "Roubaix",
    answer: <DESTINATION id={63} />,
  },
  {
    departure: "Lourdes",
    answer: <DESTINATION id={72} />,
  },
];
    ...
    return (
      <div className="flex justify-between bg-blue-100 rounded-md py-1 w-70">
        <p className="text-left px-5">
          {cityDepartureTrain[props.id % 9]} -{" "}
          {cityDestinationTrain[Math.floor(props.id / 9)]}
        </p>
        <div className="flex items-center">
          <a
