          ...
          >
            <ul className="">
              ...
              <li className="flex flex-col md:flex-row gap-4">
                ...
                <button
                  onClick={onDeconnect}
                  className="focus:outline-none text-white px-4 py-2 font-bold flex-1 flex gap-2 items-center bg-red-500 rounded-xl"
                >
                  Se déconnecter
                </button>
              </li>
          ...
          <div>
            <ul className="flex items-center">
              ...
              <li className="px-2 py-2 flex gap-2 ml-4">
                ...
                <button
                  onClick={onDeconnect}
                  className="focus:outline-none flex-auto text-white px-4 py-2 font-bold flex gap-2 bg-red-500 rounded-xl focus:outline-none"
                >
                  Se déconnecter
                </button>
              </li>
