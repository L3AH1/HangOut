          ...
          >
            <ul className="">
              ...
              <li className="flex flex-col md:flex-row gap-4">
                    <button onClick={onDeconnect} className="focus:outline-none text-white px-4 py-2 font-bold flex-1 flex gap-2 items-center bg-gradient-to-r from-red-400 to-red-800 rounded-xl">
                      Se déconnecter
                    </button>
                <Link href="/account">
        ...
        <div className="hidden lg:flex justify-between">
          ...
          <ul className="flex items-center">
                <li className="px-2 py-2 uppercase">
                  <Link href="/">
                    <a className="onglet hover:text-blue-600 text-blue-600 font-bold" onClick={handleClick}>
                      Accueil
                    </a>
                  </Link>
                </li>
                <li className="px-2 py-2 uppercase">
                  <Link href="/presentation">
                    <a className="onglet hover:text-blue-600" onClick={handleClick}>
                      Présentation
                    </a>
                  </Link>
                </li>
              ...
              <li className="px-2 py-2 flex gap-2 ml-4">
                ...
                <a>
                  ...
                  <button onClick={onDeconnect} className="focus:outline-none flex-auto text-white px-4 py-2 font-bold flex gap-2 items-center bg-gradient-to-r from-red-400 to-red-800 rounded-xl focus:outline-none">
                    Se déconnecter
                  </button>
              </li>
            </ul>
